...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_generator_py/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "cbe6a8fb8d91ee3d684d9c6bbcac6a29c710ca38cad305cd2ff7c3e40563d100";
  };
