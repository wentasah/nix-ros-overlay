...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_generator_c/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "04f4f77fda8fbf9168961c8d0ed858552e0cbcaf483edf5825c9d0b349421cb4";
  };
