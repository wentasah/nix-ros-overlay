...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_typesupport_c/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "8a221c229ac0ee454aae935a016a5ae10a1c90b0c359fd31e3298e0fa68e4ece";
  };
