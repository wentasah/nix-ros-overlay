...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.33.0-1.tar.gz";
    name = "4.33.0-1.tar.gz";
    sha256 = "a4b46852e0a947374d68aac091e9a8cb6fee33ee0a290ef69a7326e86938f6b3";
  };
