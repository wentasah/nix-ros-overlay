...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_bms_broadcaster/2.9.13-1.tar.gz";
    name = "2.9.13-1.tar.gz";
    sha256 = "a48a13b8d9a622ac83235c3ff2767f200491dcae5ae86bf440d78e7cca3d28cb";
  };
