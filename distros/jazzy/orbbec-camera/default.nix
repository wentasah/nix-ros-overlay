...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/orbbec_camera_v2-release/archive/release/jazzy/orbbec_camera/2.9.3-1.tar.gz";
    name = "2.9.3-1.tar.gz";
    sha256 = "e8a9f3a98e019139410c2ade7ee1914a37fba87c4743c48d03d931a330d6f8fb";
  };
