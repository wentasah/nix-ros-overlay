...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_control/2.9.13-1.tar.gz";
    name = "2.9.13-1.tar.gz";
    sha256 = "578f32ede1763671f012dce3630387062cbd37e1dece8605be5acae145761f21";
  };
