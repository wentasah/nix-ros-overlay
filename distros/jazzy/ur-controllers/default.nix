...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_controllers/3.3.2-1.tar.gz";
    name = "3.3.2-1.tar.gz";
    sha256 = "58be7b912d3ab2045a3db90488063426e2aa214b448f7ba65e93cc1c2a3dfc50";
  };
